...
> 洛谷试炼场的题目确实很具有代表性，但近几年又涌现出许多经典题目，本题单是洛谷试炼场的扩展与补充。

来源：[StudyingFather 的博客](https://studyingfather.com/archives/841) ｜ 共 **724 道题**，覆盖 10 大专题。

## 食用指南

- **初学者**：先完成 Part 1、2，打好语言与基础算法底子。
- **CSP-S 选手**：在基础上优先完成 Part 3.1–3.4、4.1–4.4、6.1–6.5、7.1–7.8、8.1–8.7，再继续向后推进。
- 每个专题**先给模板题，其余按难度递增**；难度较高的综合题建议能力足够后再碰。

## 许可协议

CC BY-SA 4.0 + The Star And Thank Author License——可自由共享演绎，但须署名、以相同方式共享，并为 [GitHub 仓库](https://github.com/StudyingFather) 点 Star。

## 更新日志（最近三条）

- **3.0.2**（2020/2/28）：添加少量比赛题目；移除做法重复的题。
- **3.0.1**（2019/12/8）：添加 CSP2019 及公开赛题目；跟进洛谷域名更换。
- **3.0**（2019/10/13）：新增回文自动机、K-D Tree、自适应辛普森法、左偏树、置换群、离线算法、构造、DLX、三分法、珂朵莉树等专题。
